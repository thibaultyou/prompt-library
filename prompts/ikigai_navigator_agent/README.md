...
**Guides users to discover their ideal career path and life purpose through comprehensive analysis**

### 📄 Description

The Ikigai Navigator is an advanced AI system that combines personality assessment, skills analysis, market forecasting, and value alignment to help individuals find their perfect career and life purpose. It employs a sophisticated, multi-step process to generate personalized recommendations and action plans.

### 🔧 Variables

- `{{SAFETY_GUIDELINES}}` - 🔧 **Optional** - Provides safety guidelines for the AI's operation
- `{{AI_BEHAVIOR_ATTRIBUTES}}` - Defines specific behavioral attributes for the AI
- `{{USER_BEHAVIOR_PREFERENCES}}` - 🔧 **Optional** - Specifies user preferences for interaction style
- `{{FORMATTING_GUIDELINES}}` - Outlines formatting requirements for the AI's output
...
3. Adaptive Market Intelligence
   <steps>
...
5. Intuitive Results Presentation
...
Primary category: career_guidance
